...
/**
 *this service provides all the http requests to back-end related to menuItem.
 * the structure of the menuItems refers to the structure of the navigation in visitor view.
 */
angular.module('appServiceAPI').service('menuItemService', function ($http) {
    ...
    /**
     * gets the top menuItem of a sub page
     * @returns {HttpPromise}
     */
    ...
    /**
     * updates the top menuItem of a sub page
     * the parent reference of a sub page either changes to another top menuItem
     * or
     * it sends -1 to make the sub page become top itself(by removing the parent reference in back-end)
     * @returns {HttpPromise}
     */
    ...
    /**
     * restore page to draft pages from trash section.
     * @param menuItem
     * @returns {HttpPromise}
     */
    ...
    /**
     * request to update sequence when a menuItem is removed from the list, deletes the page by given Id and send it to trash pages.
     * @param menuItemId
     * @returns {*}
     */
